...
def fitness(filename, R_rates, UGaps,  lines_file = "test.f2group.txt", error_rates = "error.rates.txt"):
        ...
        #UGaps needs to be the gap positions to be changed (note the position is zero-based indexing)
        def calc_v0(r_rates):
                ...
                AA = [0.32282991997036703, 0.0032144450727340465, 0.00060028423756015479, 1e-08, 0.0026714878898584419, 1e-08, 1e-08, 1e-08, 0.0040593236871382552, 1e-08, 1e-08, 1e-08, 0.020172154873966824, 0.014798254009578899, 0.0096104998441056081, 0.0047709371143403907, 0.0072965937155492818]
                BB = [0.32071432101803421, 0.0032144450727340465, 0.00060028423756015479, 1e-08, 0.0026714878898584419, 1e-08, 1e-08, 1e-08, 0.0040593236871382552, 1e-08, 1e-08, 1e-08, 0.020172154873966824, 0.014798254009578899, 0.0096104998441056081, 0.0047709371143403907, 0.0072965937155492818]
                CC = [0.32282991997036703, 0.0032133662480030214, 0.00060028423756015479, 1e-08, 0.0026714878898584419, 1e-08, 1e-08, 1e-08, 0.0040593236871382552, 1e-08, 1e-08, 1e-08, 0.020172154873966824, 0.014798254009578899, 0.0096104998441056081, 0.0047709371143403907, 0.0072965937155492818]
                print -final_scipy_ln_like0(AA), -final_scipy_ln_like0(BB), -final_scipy_ln_like0(CC)
                solution.append(ln_l)
                print 'function calls and interations:', d['funcalls'], d['nit']
